classdef Nano17Data
    ...
    methods
        function obj = Nano17Data(filepath, cal_slopes)
            obj.path = filepath;
           
            % import CSV and apply calibration to forces
            obj.raw = importRosNano17CSV(filepath, cal_slopes);
            
            % convert from UNIX time
            obj.time = (obj.raw.time - obj.raw.time(1))/1e9;
        ...
        function time = get.time_unix(obj)
            time = obj.raw.time;
        end
