...
fprintf('Phantom Trials: Maximum ait 3d tip error %2.2f\n', maxAITTipErr);
...
fprintf('Phantom Trials: Maximum magnet center error %2.2f\n', maxMagCenterErr);
...
fprintf('Phantom Trials: Maximum euler angular offset of Magnet %2.2f deg\n',max_mag_Rerr);
...
fprintf('Phantom Trials: Maximum euler angular offset of AIT %2.2f deg\n',max_ait_Rerr);