function h1 = stdshade(amatrix,alpha,acolor,F,smth)
...
hold on; 
h1 = plot(F,amean,'Color',acolor,'LineWidth',1.5); %% change color or linewidth to adjust mean line
